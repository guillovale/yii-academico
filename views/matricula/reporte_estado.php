...
$this->title = 'Estudiantes por estdo civil: '.$per;#. ' '. 'período :'. $idper;
...
<div class="col-xs-6">
    ...
    <?php echo $this->render('_searchestado', ['model' => $searchModel]); ?>
...
<div class="col-xs-6">
		...
		*/
		...
		$graph_data[] = array($arr['ec_nombre'], $arr['total']); 
