...
class NotassicController extends Controller
{
     ...
     */
    protected function findModel($codigo, $cedula)
    {
        if (($model = NotasSic::findOne(['codigo' => $codigo, 'cedula' => $cedula])) !== null) {
            return $model;
        } else {
	...
	{	
		...
		$usuario = Yii::$app->user->identity;
			//->LoginUsu)?Yii::$app->user->identity->LoginUsu:'';


		if ($periodo && $usuario) {

			if ($usuario->idperfil = 'dircad' || $usuario->idperfil = 'sa') {
